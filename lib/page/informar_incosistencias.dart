...
class InformarInconsistencias extends StatefulWidget {
  ...
  @override
  State<InformarInconsistencias> createState() =>
      _InformarInconsistenciasState();
}
              ...
              children: <Widget>[
                ...
                Container(
                  child: Text(
                    "Latitude: " +
                        grau(
                            widget.snapshot.data['point'].latitude.toString()) +
                        "°" +
                        minuto(
                            widget.snapshot.data['point'].latitude.toString()) +
                        "'" +
                ...
                Container(
                  ...
                  child: Text(
                    "Longitude: " +
                        grau(widget.snapshot.data['point'].longitude
                            .toString()) +
                        "°" +
                        minuto(widget.snapshot.data['point'].longitude
                            .toString()) +
                        "'" +
                        segundo(widget.snapshot.data['point'].longitude
                            .toString()) +
                        '" W',
                    textAlign: TextAlign.justify,
                    style: TextStyle(
                  ...
                  child: Align(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () => _launchLink(
                        Uri.parse(widget.snapshot.data["doi"]),
                      ),
                      child: Text(
