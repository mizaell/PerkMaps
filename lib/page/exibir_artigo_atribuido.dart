...
class ExibirArtigoAtribuido extends StatefulWidget {
  final DocumentSnapshot snapshot;

  ExibirArtigoAtribuido(this.snapshot);

  @override
  State<ExibirArtigoAtribuido> createState() => _ExibirArtigoAtribuidoState();
}

class _ExibirArtigoAtribuidoState extends State<ExibirArtigoAtribuido> {
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    "Seu artigo está em processo de avaliação para ser inserido ao nosso mapa.",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 20,
